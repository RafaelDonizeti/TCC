...
from despesas order by data_despesa desc "; // Expressão SQL que irá ser executada
        ...
        <form action="cadastrarDespesa.php" method="get">
            ...
            <div class="ms-5 mt-5">
                ...
                <div>
                    ...
                    <input type="text" class="form-control border border-1 border-secondary" name="despesa"> <br />
                    
                    <label> Valor: </label> <br />
                    <input type="text" class="form-control border border-1 border-secondary" name="valor"> <br />
                    <label> Data: </label> <br />
                    <input type="date" class="form-control border border-1 border-secondary" name="data"> <br />
    ...
    <div class="col mt-5 mx-5">
        <table class="table table-bordered  ">
          ...
          <tr>
            ...
            <td><?php echo number_format( $row['valor_despesa'], 2 ,',','.'); ?> </td>
