...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Out-2022 às 06:32
...
CREATE TABLE `mural_de_recados` (
  ...
  `id_usuario_fk` int(11) NOT NULL,
  `descricao_recado` varchar(1330) NOT NULL,
...
(64, 106, 'ssssssssssssssssssssssssssssss', '2022-10-26 03:10:33', 0),
(69, 106, 'salve ', '2022-10-26 04:23:33', 2);
...
(106, 'Rafael', '996077228', 'rafadruzian@gmail.com', 3, '81dc9bdb52d04dc20036dbd8313ed055', 106),
(115, 'Rincon Sapiencia', '14656565656', 'lapu@gmail.com', 2, '1ce927f875864094e3906a4a0b5ece68', 110);
...
--
ALTER TABLE `mural_de_recados`
  MODIFY `id_recado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `imoveis`
  ADD CONSTRAINT `imoveis_ibfk_2` FOREIGN KEY (`id_bloco_fk`) REFERENCES `blocos` (`id_bloco`);
COMMIT;
